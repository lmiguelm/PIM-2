...
void totalizacaoDiariaMensal()
{
  ...
  for (int i = 0; i < consultas.used; i++)
  {
    if (consultas.arrayDeConsultas[i].unidade == 1)
    {
      if (consultas.arrayDeConsultas[i].data.mes == data_atual->tm_mon &&
          consultas.arrayDeConsultas[i].data.ano == data_atual->tm_year)
      {
        mensal1 += consultas.arrayDeConsultas[i].preco;
      }
      if (consultas.arrayDeConsultas[i].data.dia == data_atual->tm_mday &&
          consultas.arrayDeConsultas[i].data.mes == data_atual->tm_mon &&
          consultas.arrayDeConsultas[i].data.ano == data_atual->tm_year)
      {
